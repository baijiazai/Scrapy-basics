...
class TongshuSpider(scrapy.Spider):
    ...
    start_urls = [
        'http://category.dangdang.com/cp01.41.05.00.00.00.html',
        'http://category.dangdang.com/cp01.41.46.00.00.00.html',
        'http://category.dangdang.com/cp01.41.55.00.00.00.html',
        'http://category.dangdang.com/cp01.41.45.00.00.00.html',
        'http://category.dangdang.com/cp01.41.59.00.00.00.html'
    ]
    ...
    def parse_reply(self, response):
        ...
        for user in users:
            user_info = {
                'content': user.xpath('./div[@class="items_right"]/div[@class="describe_detail"]/span/a/text()').get(),
